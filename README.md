...
```
cd rtl8812au
wget https://raw.githubusercontent.com/ivanovborislav/document/main/patch/rtl8812au_v5.13.6_kernel_5.19.2-6.0.0rc3.patch
patch -p1 < rtl8812au_v5.13.6_kernel_5.19.2-6.0.0rc3.patch
sudo make uninstall
make clean
make
sudo make install
