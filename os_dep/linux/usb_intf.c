...
static struct usb_device_id rtw_usb_id_tbl[] = {
	...
	{USB_DEVICE(0x2357, 0x010D), .driver_info = RTL8812}, /* TP-Link - T4U */
	...
	{USB_DEVICE(0x2357, 0x0101), .driver_info = RTL8812}, /* TP-Link - T4Uv1 */
	{USB_DEVICE(0x2357, 0x0103), .driver_info = RTL8812}, /* TP-Link - T4UHv1 */
	{USB_DEVICE(USB_VENDER_ID_REALTEK, 0xA812), .driver_info = RTL8812}, /* Default ID */
	{USB_DEVICE(0x050D, 0x1109), .driver_info = RTL8812}, /* Belkin - F9L1109v1 */
	{USB_DEVICE(0x20F4, 0x805B), .driver_info = RTL8812}, /* TRENDnet - TEW-805UB */
	{USB_DEVICE(0x0846, 0x9051), .driver_info = RTL8812}, /* Netgear - A6200v2 */
	{USB_DEVICE(0x13B1, 0x003F), .driver_info = RTL8812}, /* Linksys - WUSB6300v1 */
	{USB_DEVICE(0x148F, 0x9097), .driver_info = RTL8812}, /* Amped - ACA1 */
	{USB_DEVICE(0x08C4, 0x0115), .driver_info = RTL8812}, /* Proxim - ORiNOCO*/
